...
sudo apt install libx11-dev libxext-dev libxcursor-dev libxi-dev libxrandr-dev libxfixes-dev libxss-dev libxtst-dev # x11
sudo apt install libpulse-dev libgl-dev # 驱动
