...
std::string_view toString(OpcodeType type) {
    switch (type) {
        ...
        TO_STRING_CASE(OpcodeType, OpGetBuiltin);
        ...
        TO_STRING_CASE(OpcodeType, OpCurrentClosure);
    }
...
inline const std::map<OpcodeType, Definition> definitions{
    ...
    {OpcodeType::OpGetBuiltin, {"OpGetBuiltin", {1}}},
    ...
    {OpcodeType::OpCurrentClosure, {"OpCurrentClosure", {}}},
};
