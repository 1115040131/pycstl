...
TEST(LexerTest, NextTokenTest) {
    ...
    std::vector<Token> tests{
        ...
        {Token::Type::kInt, "5"},        {Token::Type::kSemicolon, ";"},   {Token::Type::kLet, "let"},
        {Token::Type::kIdent, "ten"},    {Token::Type::kAssign, "="},      {Token::Type::kInt, "10"},
        {Token::Type::kSemicolon, ";"},  {Token::Type::kLet, "let"},       {Token::Type::kIdent, "add"},
        {Token::Type::kAssign, "="},     {Token::Type::kFunction, "fn"},   {Token::Type::kLParen, "("},
        {Token::Type::kIdent, "x"},      {Token::Type::kComma, ","},       {Token::Type::kIdent, "y"},
        {Token::Type::kRParen, ")"},     {Token::Type::kLBrace, "{"},      {Token::Type::kIdent, "x"},
        {Token::Type::kPlus, "+"},       {Token::Type::kIdent, "y"},       {Token::Type::kSemicolon, ";"},
        {Token::Type::kRBrace, "}"},     {Token::Type::kSemicolon, ";"},   {Token::Type::kLet, "let"},
        {Token::Type::kIdent, "result"}, {Token::Type::kAssign, "="},      {Token::Type::kIdent, "add"},
        {Token::Type::kLParen, "("},     {Token::Type::kIdent, "five"},    {Token::Type::kComma, ","},
        {Token::Type::kIdent, "ten"},    {Token::Type::kRParen, ")"},      {Token::Type::kSemicolon, ";"},
