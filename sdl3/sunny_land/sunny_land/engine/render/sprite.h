...
public:
     ...
     */
    Sprite(std::string_view texture_id, const std::optional<SDL_FRect>& source_rect = std::nullopt,
    ...
    const std::optional<SDL_FRect>& getSourceRect() const { return source_rect_; }  ///< @brief 获取源矩形
