...
public:
     ...
     * @return 音效正在播放的通道，出错时返回 none。
     */
    std::optional<int> playSound(std::string_view sound_path, int channel = -1);
     ...
     */
    bool playMusic(std::string_view music_path, int loops = -1, std::chrono::milliseconds fade_in_ms = {});
