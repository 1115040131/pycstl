...
public:
     ...
     */
    UIImage(std::string_view texture_id, glm::vec2 position = {0.0f, 0.0f}, glm::vec2 size = {0.0f, 0.0f},
            std::optional<SDL_FRect> source_rect = std::nullopt, bool is_flipped = false);
