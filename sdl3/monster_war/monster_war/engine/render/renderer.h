...
public:
    ...
    void drawSprite(const Camera& camera, const Sprite& sprite, const glm::vec2& position, const glm::vec2& size,
                    const float rotation = 0.0f, const FColor& color = FColor::white());
     ...
     * @param color 填充颜色
     */
    void drawFilledRect(const Camera& camera, const glm::vec2& position, const glm::vec2& size,
                        const FColor& color);
     ...
     * @param color 边框颜色
     */
    void drawRect(const Camera& camera, const glm::vec2& position, const glm::vec2& size, const FColor& color,
