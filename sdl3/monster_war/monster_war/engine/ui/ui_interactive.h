...
public:
    ...
    void addImage(entt::id_type name_id, Image image);                      ///< @brief 添加精灵
    ...
    // --- 核心方法 ---
    bool handleInput(Context& context) override;
...
protected:
    ...
    ///< @brief 精灵集合
    std::unordered_map<entt::id_type, Image> images_;          ///< @brief 精灵集合
