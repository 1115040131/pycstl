...
public:
     ...
     * @return 玩家单位实体
     */
    entt::entity createPlayerUnit(entt::id_type class_id, const glm::vec2& position, int level = 1,
                                  int rarity = 1);
     ...
     * @return 单位准备类型实体
     */
    entt::entity createUnitPrep(entt::id_type name_id, entt::id_type class_id, int cost,
     ...
     * @return 敌人死亡特效实体
     */
    entt::entity createEnemyDeadEffect(entt::id_type class_id, const glm::vec2& position,
...
private:
    ...
    void addSpriteComponent(entt::entity entity, const SpriteBlueprint& sprite, const bool is_flipped = false);
    ///< @brief 正常动画组件添加（多个动画）
    ...
    void addOneAnimationComponent(entt::entity entity, const AnimationBlueprint& animation_blueprint,
                                  const SpriteBlueprint& sprite_blueprint, entt::id_type animation_id,
                                  bool loop = false);
    void addStatsComponent(entt::entity entity, const StatsBlueprint& stats, int level = 1, int rarity = 1);
