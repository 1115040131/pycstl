...
class GPT(nn.Module):
    ...
    def configure_optimizers(self, weight_decay, learning_rate, device_type) -> torch.optim.Optimizer:
...
# optimize!
optimizer: torch.optim.Optimizer = raw_model.configure_optimizers(
