...
TEST(VectorTest, test_construction) {
    ...
    COMPARE_VEC_WITH_STL(vec5, stl_vec5);

    auto vec6 = vec4;
    auto stl_vec6 = stl_vec4;
    COMPARE_VEC_WITH_STL(vec6, stl_vec6);
    ...
    COMPARE_CONTENT_WITH_STL(bar, stl_vec1);
